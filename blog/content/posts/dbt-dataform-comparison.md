...
date: 2021-02-08T10:40:39+09:00
draft: false
...
* 私の所属する会社 ([Ubie, inc](https://recruit.ubie.life/)) では、学習コストよりも機能の充実度や外部との接続性を高く評価し、dbtを選択しました。
...
ただし、Dataformでも必要十分な機能は備えている印象です。
...
また、 **「運用コスト」** については、すでにCloud Composerで他のジョブも管理しているので、新たにスケジューラーを準備する必要はなく、むしろCloud Composerにまとめられるので良いと考えました。
